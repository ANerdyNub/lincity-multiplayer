...
extern int no_autosave;
extern int network_game;
extern int network_is_host;
extern int network_socket;
extern int network_extra_fds[MAX_CLIENTS - 1];
extern int network_num_clients;
extern int network_max_clients;
extern int network_drag_count;
...
#endif
extern int kmousex, kmousey, kmouse_val, reset_mouse_flag, mt_flag, mb_flag;
...
extern int quit_flag, network_flag, load_flag, save_flag, autosave_flag, cheat_flag;
