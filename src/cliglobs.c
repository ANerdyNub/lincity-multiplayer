...
int no_autosave = 0;
int network_game = 0;
int network_is_host = 0;
int network_socket = -1;
int network_extra_fds[MAX_CLIENTS - 1] = {-1, -1, -1};
int network_num_clients = 0;
int network_max_clients = 0;
int network_drag_count = 0;
...
#endif
int kmousex, kmousey, kmouse_val, reset_mouse_flag, mt_flag = 0, mb_flag = 0;
...
int quit_flag, network_flag, load_flag, save_flag, autosave_flag;
